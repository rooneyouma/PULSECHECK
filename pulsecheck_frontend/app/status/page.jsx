    ...
    <div style={{
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Shared column grid: name | url | uptime+bar | badge */
        .hub-table-row {
          display: grid;
      ...
      <div className="hub-header-pad" style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          <span
            style={{ fontSize: "13px", fontWeight: "500", letterSpacing: "0.15em", color: "#e2e8f0", cursor: "pointer" }}
            onClick={() => router.push("/")}
          >
            PULSECHECK
          </span>
      ...
      <div className="hub-page-pad" style={{ maxWidth: "960px", margin: "0 auto", padding: "40px 32px" }}>
        ...
        <div style={{
          ...
          {/* Table Header — uses same grid class as rows */}
          ...
          {!isLoading && !isError && sites.map((site, idx) => {
            ...
            return (
              ...
              >
                ...
                {/* Col 2: URL */}
                <span className="hub-col-url" style={{
                ...
                {/* Col 3: mini bar + uptime % */}
                <div className="hub-col-uptime" style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                  <MiniBar is_up={isUp} />
                  <span style={{
                    fontSize: "12px", color: isUp ? "#00ff88" : "#ff3b5c",
                    fontWeight: "500", minWidth: "42px", textAlign: "right",
                  }}>
                    {site.uptime}%
                  </span>
                </div>
                ...
                <div className="hub-col-badge" style={{
                  ...
                  <span style={{
                    fontSize: "9px", letterSpacing: "0.12em", color: dotColor,
                    whiteSpace: "nowrap",
                  }}>
